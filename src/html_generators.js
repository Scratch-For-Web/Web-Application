...
HtmlGenerator['divclass'] = function(block) {
...
HtmlGenerator['meta_org'] = function(block) {
    var content = HtmlGenerator.statementToCode(block, 'meta');
    var code = `
...
HtmlGenerator['meta_title'] = function(block) {
    var text_content = block.getFieldValue('content');
    var code = `<meta property="og:title" content="${text_content}" />`+ '\n';
    return code;
};
HtmlGenerator['meta_desc'] = function(block) {
    var text_content = block.getFieldValue('content');
    var code = `<meta property="og:description" content="${text_content}" />`+ '\n';
    return code;
};
HtmlGenerator['meta_img'] = function(block) {
    var text_content = block.getFieldValue('content');
